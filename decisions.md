...
- **Intent signals (not vibe votes).** The voting mechanic is account-bound *intent signals* — "I'm going there tonight" — not subjective vibe ratings. One intent per user per night per location. Stored in the `intents` table. "Anonymous" means publicly anonymous, not unlinked from account. Displayed as percentages of intent share across locations, not named avatars. **Supersedes prior "Vote integrity" decision (2026-05-02), which framed the mechanic as vibe voting.** Resolved 2026-05-22 via Build Lead schema chat Q9.
